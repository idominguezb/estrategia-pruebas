...
describe('Posts flow', function () {
    ...
    it('Post', function () {
        ...
        cy.wait(1000);
        scenario_title_number('/scenario_createPost');
    });
});
...
// Creación de un post
function scenario_title_number(directory) {
    login(directory)

    post(directory)

    writerPost(directory, data[4].id != null ? data[4].id : ' ', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ');
