...
describe('Posts flow', function () {
    ...
    it('Post', function () {
        ...
        cy.wait(1000);
        scenario_title_text_random('/scenario_createPost');
    });
});
...
// Creación de un post
function scenario_title_text_random(directory) {
    login(directory)

    post(directory)

    writerPost(directory, data[4].text_random != null ? data[4].text_random : ' ', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ');
