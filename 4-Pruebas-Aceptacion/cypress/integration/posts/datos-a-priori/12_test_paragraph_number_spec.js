...
describe('Posts flow', function () {
    ...
    it('Post', function () {
        ...
        cy.wait(1000);
        scenario_title_paragraph_number('/scenario_createPost');
    });
});
...
// Creación de un post
function scenario_title_paragraph_number(directory) {
    login(directory)

    post(directory)

    writerPost(directory, data[1].title != null ? data[1].title : ' ', data[1].id);
