...
describe('Posts flow', function () {
    ...
    it('Post', function () {
        ...
        cy.wait(1000);
        scenario_title_medium('/scenario_createPost');
    });
});
...
// Creación de un post
function scenario_title_medium(directory) {
    login(directory)

    post(directory)

    writerPost(directory, data[68].title != null ? data[68].title : ' ', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ');
