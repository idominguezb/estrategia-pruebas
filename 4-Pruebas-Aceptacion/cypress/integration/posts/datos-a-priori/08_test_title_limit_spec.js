...
describe('Posts flow', function () {
    ...
    it('Post', function () {
        ...
        cy.wait(1000);
        scenario_title_limit('/scenario_createPost');
    });
});
...
// Creación de un post
function scenario_title_limit(directory) {
    login(directory)

    post(directory)

    writerPost(directory, data[4].title != null ? data[4].title.substring(0, 255) : ' ', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ');
