...
describe('Posts flow', function () {
    ...
    it('Post', function () {
        ...
        cy.wait(1000);
        scenario_title_paragraph_large('/scenario_createPost');
    });
});
...
// Creación de un post
function scenario_title_paragraph_large(directory) {
    login(directory)

    post(directory)

    writerPost(directory, data[1].title != null ? data[1].title : ' ', titleRandom(data[1].paragraph));
