...
function scenario_title(directory, postDatos) {
    ...
    writerPost(directory, 'Post con hora vacia', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ');

    let menu = cy.xpath('/html[1]/body[1]/div[2]/div[1]/main[1]/button[1]/span[1]/*[name()=\'svg\'][1]');
    menu.click({force: true});

    let inputUrl = cy.xpath('/html[1]/body[1]/div[2]/div[1]/main[1]/div[1]/div[1]/div[1]/div[1]/div[2]/form[1]/div[2]/div[1]/div[2]/input[1]');
    inputUrl.type(postDatos[getRandomInt(0, postDatos.length)].time != null ? postDatos[getRandomInt(0, postDatos.length)].time : ' ', {force: true})
