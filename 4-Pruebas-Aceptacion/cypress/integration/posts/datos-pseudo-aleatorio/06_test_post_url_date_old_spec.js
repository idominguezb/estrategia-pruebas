...
function scenario_title(directory, postDatos) {
    ...
    writerPost(directory, 'Post con fecha antigua', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ');
    ...
    inputUrl.type(postDatos[getRandomInt(0, postDatos.length)].date_old, {force: true})
