...
function scenario_title(directory, postDatos) {
    ...
    writerPost(directory, 'Post con Url con longitud uno', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ');
    ...
    inputUrl.type(postDatos[getRandomInt(0, postDatos.length)].url.substring(0,1), {force: true})
