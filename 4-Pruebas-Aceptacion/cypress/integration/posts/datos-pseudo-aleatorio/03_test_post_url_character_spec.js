...
function scenario_title(directory, postDatos) {
    ...
    writerPost(directory, 'Post con Url con caracter', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ');
    ...
    inputUrl.type(postDatos[getRandomInt(0, postDatos.length)].character != null ? postDatos[getRandomInt(0, postDatos.length)].character : ' ', {force: true})
