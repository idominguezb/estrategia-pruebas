...
function scenario_title(directory, postDatos) {
    ...
    writerPost(directory, 'Post con campo excerpt extenso', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ');
    ...
    inputUrl.type(postDatos[getRandomInt(0, postDatos.length)].paragraph+postDatos[getRandomInt(0, postDatos.length)].paragraph, {force: true})
