...
function scenario_title(directory, postDatos) {
    ...
    writerPost(directory, 'Post con formato de fecha erronea', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ');
    ...
    inputUrl.type(postDatos[getRandomInt(0, postDatos.length)].date, {force: true})
