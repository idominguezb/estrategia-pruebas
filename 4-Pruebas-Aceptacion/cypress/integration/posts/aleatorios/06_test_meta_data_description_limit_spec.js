...
describe('Posts flow', function () {
    ...
    it('Validation meta data description limit', function () {
...
function scenario_title(directory) {
    ...
    cy.xpath('/html[1]/body[1]/div[2]/div[1]/main[1]/div[1]/div[1]/div[1]/div[1]/div[2]/form[1]/ul[1]/li[1]/button[1]/b[1]').click({force:true});
    cy.wait(1000);
    cy.xpath('/html[1]/body[1]/div[2]/div[1]/main[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/form[1]/div[2]/textarea[1]').type(faker.random.words(20).substring(0,145), {force:true})
