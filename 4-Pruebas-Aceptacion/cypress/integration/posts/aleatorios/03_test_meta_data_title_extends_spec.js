...
describe('Posts flow', function () {
    ...
    it('Validation meta data title extends', function () {
...
function scenario_title(directory) {
    ...
    cy.wait(1000);
    cy.xpath('/html[1]/body[1]/div[2]/div[1]/main[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/form[1]/div[1]/input[1]').type(faker.lorem.words(20), {force:true})
