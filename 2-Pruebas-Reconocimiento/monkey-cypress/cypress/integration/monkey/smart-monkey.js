        ...
        if($inputs.length > 0){
            ...
            if(!Cypress.dom.isHidden(inp)) {
                ...
                if(inp.getAttribute("type") == "email"){
                    ...
                    if(inp.id==="ember7"){
                        cy.get('input#ember7').focus().clear();
                        cy.get('input#ember7') // 2.
                        .type('prueba@example.com') // 3.
                        cy.get('input#ember9').focus().clear();
                      cy.get('input#ember9') // 4.
                        .type('prueba@example.com123456789') // 5.
                      cy.get('button#ember11') // 6.
                        .click()
                    }else{
                    ...
                    let type = faker.random.alphaNumeric(6)
...
describe( `${appName} under smarter monkeys`, function() {
    ...
    it(`visits ${appName} and survives smarter monkeys`, function() {
        ...
        if(pcg === 100){
            ...
            cy.get('input#ember7').type('prueba@example.com') // 3.
          cy.get('input#ember9').type('prueba@example.com123456789') // 5.
          cy.get('button#ember11').click()
            cy.wait(1000)
